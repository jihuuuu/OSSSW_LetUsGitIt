...
### 3. 트렌드  
- **일일 트렌드**  
  - 매일 자정(`generate_daily_trend`)에 전날(Asia/Seoul 기준) 기사 내 키워드 등장 횟수를 집계하여 ‘일일 트렌드’ 화면에 표시합니다
- **주간 트렌드**  
  - 최근 7일 동안의 키워드 등장 추이를 시계열 그래프로 제공하여 이슈 흐름을 한눈에 확인할 수 있습니다   
...
- **내 스크랩**  
  - ‘마이 스크랩’ 화면에서 저장된 기사 목록을 제목 검색·페이징하며 확인할 수 있습니다 
- **스크랩 취소**  
